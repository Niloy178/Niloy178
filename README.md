...
**Currently learning:** Full Stack Web dev (Leaflet, React, Django, PostgreSQL/PostGIS), scalable backend architecture, ArcGIS Pro, QGIS and Google Earth Engine.
...
---
[![](https://visitcount.itsvg.in/api?id=niloy178&icon=2&color=3)](https://visitcount.itsvg.in)
